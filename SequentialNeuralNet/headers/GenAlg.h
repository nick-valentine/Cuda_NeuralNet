...
Two children Genomes(vectors of doubles) are made.
...
Each child get a chance to be mutated where their Genome (a vector of doubles) is passed into 
...
private:
	...
	void crossover(const std::vector<double> &mother, const std::vector<double> &father, 
