...
double GenAlg::get_avg_fitness()
{
	return average_fitness;
}

double GenAlg::get_best_fitness()
{
	return best_fitness;
}

double GenAlg::get_worst_fitness()
{
	return worst_fitness;
}

double GenAlg::get_total_fitness()
{
...
void GenAlg::crossover(const std::vector<double> &mother, const std::vector<double> &father,
